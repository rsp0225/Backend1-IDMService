        ...
        <StyledDiv>
            ...
            <table>
                ...
                {movies.map(movie => {
                    return (
                        <tr key={movie.id}>
                            <styleTd> <img style = {{height: "300px"}} src = {"https://image.tmdb.org/t/p/original" + movie.posterPath}/></styleTd>
                            <StyledTd> <Link to = {"/movie/" + movie.id} >{movie.title}</Link> </StyledTd>
